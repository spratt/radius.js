(function(undefined) {
	...
	function noop() {}
	function drawRanges() {
		var cold_lake_range = radius.drawCircle3d('CFB Cold Lake',
												  cold_lake,
												  range_of_a_cf18 / 2,
												  '99ffff00',
												  '60ffff00');
		var bagotville_range = radius.drawCircle3d('CFB Bagotville',
												   bagotville,
												   range_of_a_cf18 / 2,
												   '9900ffff',
												   '6000ffff');
	...
	radius.init3d('map3d',ottawa,drawRanges,noop);
})();
